          ...
          <div class="dropdown" style="width: 71%">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="dropdown-item">Dessert</a>
                <ul>
                  <li><a href="DesMilk.php" style="color: white">Milk</a></li>
                  <li><a href="DesFruit.php" style="color: white">Fruit</a></li>
                  <li><a href="DesChocolate.php" style="color: white">Chocolate</a></li>
                  <li><a href="DesJelly.php" style="color: white">Jelly</a></li>
                  <li><a href="DesYoghurt.php" style="color: white">Yoghurt</a></li>
                  <li><a href="DesBiscuit.php" style="color: white">Biscuit</a></li>
                  <li><a href="DesCheese.php" style="color: white">Cheese</a></li>
                  <li><a href="DesFlour.php" style="color: white">Flour</a></li>
                </ul>
              </li>
              <li>
                <a class="dropdown-item">Snack</a>
